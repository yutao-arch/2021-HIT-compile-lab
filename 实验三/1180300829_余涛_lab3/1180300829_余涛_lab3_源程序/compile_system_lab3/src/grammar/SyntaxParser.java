...
public class SyntaxParser {
    ...
    private Stack<TreeNode> treeNodeID = new Stack<TreeNode>();
    ;  // 用于存储相应的树节点
	...
	{
		SyntaxParser parser = new SyntaxParser("alltest.txt", tree);
		parser.analyze();
		printTree();
		writefile(result);
	}*/
    ...
    private static void writefile(StringBuffer str) {
        String path = "src/all_file/LR_Analysis_Result.txt";
        try {
