...
public class Smantic {
    ...
    public Smantic(String filename, List<Stack<Symbol>> table, List<String> three_addr, List<FourAddr> four_addr, List<String> errors) {
    ...
    public static void main(String[] args) {
        //SyntaxParser parser = new SyntaxParser("alltest.txt");
        //parser.analyze();
